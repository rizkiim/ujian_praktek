...
INSERT INTO `databasechangelog` VALUES ('1','rizki','C:/liquibase-3.0.7-bin/belajar-liquibase/pom.xml','2013-12-01 13:18:07',1,'EXECUTED','7:9ee2a220e943738ff5e216bc0d3944c7','createTable','',NULL,'3.0.7');
...
CREATE TABLE `tabel-liquibase` (
  ...
  PRIMARY KEY (`id`,`nisn`,`jurusan`,`kelas`,`jenkel`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2013-12-01 13:30:25
